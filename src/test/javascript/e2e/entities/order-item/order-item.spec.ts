...
describe('OrderItem e2e test', () => {
  ...
  it('should load create OrderItem page', async () => {
    ...
    expect(await orderItemUpdatePage.getPageTitle().getAttribute('id')).to.match(/eCommerceApp.orderItem.home.createOrEditLabel/);
  });
  ...
  /* it('should delete last OrderItem', async () => {
        ...
        expect(await orderItemDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/eCommerceApp.orderItem.delete.question/);
