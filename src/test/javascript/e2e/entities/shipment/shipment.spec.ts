...
describe('Shipment e2e test', () => {
  ...
  it('should load create Shipment page', async () => {
    ...
    expect(await shipmentUpdatePage.getPageTitle().getAttribute('id')).to.match(/eCommerceApp.shipment.home.createOrEditLabel/);
  });
  ...
  /* it('should delete last Shipment', async () => {
        ...
        expect(await shipmentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/eCommerceApp.shipment.delete.question/);
